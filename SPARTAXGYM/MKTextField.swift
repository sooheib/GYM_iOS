...
open class MKTextField : UITextField {
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        var newRect = CGRect(x: rect.origin.x + 20, y: 0,
...
private extension MKTextField {
    func setFloatingLabelOverlapTextField() {
        ...
        floatingLabel.frame = CGRect(x: 30, y: 0,
            width: floatingLabel.frame.size.width, height: 15)
    }

    func showFloatingLabel() {
        let curFrame = floatingLabel.frame
        floatingLabel.frame = CGRect(x: 0, y: 10, width: 100, height: 10)
